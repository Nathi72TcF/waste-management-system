...
@Component({
  ...
  templateUrl: './outbound-pdf.page.html',
  styleUrls: ['./outbound-pdf.page.scss'],
})
export class OutboundPDFPage implements OnInit {
  ...
  content: [
    ...
    //     widths: ['33%', '33%', '33%'],
    //     body: [
    //       ["Truck Driver", "Ship To", "Transaction ID",],
    ...
    { text: '', style: 'subheader' },
    {
      ...
      table: {
        ...
        body: [
          ...
          [{ text: 'TOTAL', bold: true, lineHeight: 2, marginTop: 10, },
            { text: this.overallStoragez, bold: true, lineHeight: 2, marginTop: 10 },]
        ]
      }
    },
    { text: '', style: 'subheader'},
